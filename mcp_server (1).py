...
if __name__ == "__main__":
    ...
    # stateless_http: every call is self-contained (no session id to lose behind
    #   a proxy / multi-instance host) — fixes orchestrator time-outs.
    # json_response: return one JSON reply instead of a long-lived SSE stream
    #   that proxies tend to buffer (which also looks like a time-out).
